...
bool ModuleGame::Start()
{
	...
	// 2. ÉèÖÃÍæ¼ÒÎ»ÖÃ (ÐÞ¸´ÖØµã£ºÈ¡Ïû×¢ÊÍ²¢×ª»»×ø±êµ¥Î»)
	if (App->player->pbody != nullptr) {
		// ±ØÐë½« Tiled µÄÏñËØ×ø±ê×ª»»ÎªÎïÀíÒýÇæµÄÃ××ø±ê
	...
	{
		// ÕâÀïµÄ 0 ÊÇÂ·¾¶Ë÷Òý£¬Äã¿ÉÄÜÐèÒªÂß¼­À´¼ÆËã¸ÃÉú³ÉµãÀëÄÄ¸öÂ·¾¶µã×î½ü
...
update_status ModuleGame::PostUpdate()
{
	...
	// ÔÚÆÁÄ»ÏÔÑÛÎ»ÖÃÏÔÊ¾Íæ¼Òµ±Ç°ÅÅÃû
...
void ModuleGame::OnCollision(PhysBody* bodyA, PhysBody* bodyB)
{
	...
	if (sensor && vehicleBody) {
		...
		// 3. ´¦ÀíÂß¼­£¨ÌáÈ¡³É lambda »òº¯ÊýÒÔ¸´ÓÃ£©
